  ...
  return (
    ...
    >
      <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
        ...
        >
          Unlock customized solutions to unify your financial operations and take the stress out of accounting. 
          Don’t wait—start your journey toward better financial management today!
        </Typography>
