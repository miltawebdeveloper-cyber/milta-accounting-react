...
function App() {
  ...
  useFullSEO({
    ...
    ogDescription: "Professional virtual assistant services for small businesses. Specializing in real estate, data entry, bookkeeping, event planning, and more. Affordable and scalable solutions.",
