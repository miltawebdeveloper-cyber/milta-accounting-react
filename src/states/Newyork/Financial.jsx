      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <Box component="span" sx={{ color: hoverOrange }}>
            Financial Controller Services in New York
          </Box>
        </Typography>
        ...
        >
          💼 Book Your Free Consultation Today – Limited Time Only! ⏰ Act Fast! Offer expires in 48 hours.
        </Button>
      </Container>
    </Box>
  );
...
/* ================= SECTION ================= */
const Section = ({ title, children, bg, center = true }) => (
...
const FAQSection = () => {
  const faqData = [
    ...
    },
    {
      ...
      a: "Outsourcing gives you access to elite experience at a fraction of the price of employing a full-time controller.",
    },
    {
...
/* ================= PAGE ================= */
export default function FinancialControllerNewYork() {
  useFullSEO({
  // MAIN SEO
  ...
  return (
    <>
      ...
      <Section title="Certified Financial Controller Services in New York">
        <Typography mb={3}>
      ...
      <Section title="Why Choose Our Financial Controller Services">
        <Typography mb={4}>
      ...
      {/* Last two sections remain left-aligned */}
      <Section title="Capabilities – Controller vs CFO" bg={white} center={true}>
        <CapabilitiesTable />
      </Section>
