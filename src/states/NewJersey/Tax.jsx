...
- Miscellaneous income (jury duty, gambling winnings, Medical Savings Accounts, scholarships, etc.)`
  },
  {
    ...
    a: "Yes, we provide complete tax preparation services in New Jersey for federal, state, and city taxes, ensuring compliance at all levels."
  },
  {
  ...
  return (
    <>
      <BannerSection />
      <Section title="Specializing in Business & Individual Tax Planning and Preparation in New Jersey">
  <Typography
    mb={3}
    textAlign="center"
  ...
  >
    As a business owner, your focus should be on scaling your products, services, and
    operations—not on juggling financial statements, deciphering tax codes, or keeping
    up with changing regulations. While a local accounting firm near you may have met
    your needs at first, growth calls for more sophisticated solutions.
  </Typography>
  ...
  <Typography
    ...
    fontSize={{ xs: "0.9rem", sm: "1rem", md: "1.1rem" }}
  >
    From payroll management and cash flow optimization to quarterly tax estimates,
    addressing these challenges requires ongoing expertise and proactive planning.
  </Typography>
  ...
  <Typography
    ...
    fontSize={{ xs: "0.9rem", sm: "1rem", md: "1.1rem" }}
  >
    At Milta, we offer specialized tax preparation services in New Jersey, combining
    proactive tax planning and preparation to ensure compliance while maximizing
    savings. Whether you’re a startup or an established business seeking reliable tax
    services near you, we provide comprehensive support that adapts with your business,
    ensuring financial clarity long after April 15.
  </Typography>
</Section>
      ...
      <Section title="Why Partner With Us?">
        <HighlightBoxes boxes={highlightBoxes} />
                ...
                <div>
    <GlassCTA
      title="Simplify Your Taxes Now!"
      description="Our New Jersey tax experts make filing easy and stress-free."
      buttonText="Get Your Free Consultation"
      onButtonClick={() => alert("Button clicked!")}
      backgroundGradient="rgba(255, 151, 24, 1)" // optional
      headingGradient="linear-gradient(90deg, #081f02ff, #033a13ff)" // optional
      buttonGradient="linear-gradient(90deg, #042c10b6, #053d1aff)" // optional
    />
  </div>
