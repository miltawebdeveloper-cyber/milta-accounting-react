...
- Miscellaneous income (jury duty, gambling winnings, Medical Savings Accounts, scholarships, etc.)`
  ...
  return (
    <>
      <BannerSection
        title="Unlock the Full Potential of Your Refund with Premier Tax Services Near Me!"
        description="Our esteemed accounting firm is dedicated to guiding you through all your tax planning and preparation requirements in South Carolina."
        buttonText="Schedule Your Complimentary Consultation Today!"
      />

      <Section title="Expertise in Business and Individual Tax Strategy and Preparation in South Carolina">
      ...
      <GlassCTA
        ...
        description="If you're looking for tax services near me, our tax preparation services in South Carolina ensure accuracy and compliance every step of the way."
