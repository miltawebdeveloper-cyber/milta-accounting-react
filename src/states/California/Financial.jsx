    ...
    >
      <Container maxWidth="md">
        ...
        <Typography
          ...
          opacity={0.95}
        >
          We provide expert financial controller services in California to enhance reporting, strengthen controls, and maintain full financial compliance.
        </Typography>
  ...
  return (
    <>
      ...
      <Section title="Why Choose Miltafs Financial Controller Services">
        <Typography mb={4}>
          Our accounting controller experts provide strategic insights to help businesses in California and beyond drive profitability and sustainable growth.
        </Typography>
